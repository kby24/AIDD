...
parser.add_argument('--dim', type=int, default=4, help='# information dimension of each node spring:4 ')
...
# load_data
if args.sys== 'spring':
    train_loader, val_loader, test_loader, object_matrix = load_spring(batch_size=HYP['batch_size'],node_num=args.nodes,network=args.network,exp_id=args.exp_id)
...
adj_path = './model/adj_spring_' + args.network + '_' + str(args.nodes) + '_id' + str(args.exp_id) + '.pkl'
