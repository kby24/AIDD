...
# load_data
if args.sys== 'cmn':
    train_loader, val_loader, test_loader, object_matrix = load_cmn(batch_size=HYP['batch_size'],node_num=args.nodes,network=args.network,exp_id=args.exp_id)
...
adj_path = './model/adj_cmn_' + args.network + '_' + str(args.nodes) + '_id' + str(args.exp_id) + '.pkl'
