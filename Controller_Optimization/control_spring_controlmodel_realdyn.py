...
control_isom = torch.load(control_path).to(device)
# load_data
if args.sys== 'spring':
...
data_path = './data/control_spring_'+str(args.network)+'_controlmodel_realdyn_data_id'+str(args.exp_id)+'.pickle'
loss_path = './data/control_spring_'+str(args.network)+'_controlmodel_realdyn_loss_id'+str(args.exp_id)+'.pickle'
