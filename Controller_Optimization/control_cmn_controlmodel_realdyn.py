...
control_path = './model/control_cmn_'+str(args.network)+'_ourmodel_ournet_model_id'+str(args.exp_id)+'.pkl'
...
data_path = './data/control_cmn_'+str(args.network)+'_controlmodel_realdyn_data_id'+str(args.exp_id)+'.pickle'
loss_path = './data/control_cmn_'+str(args.network)+'_controlmodel_realdyn_loss_id'+str(args.exp_id)+'.pickle'
